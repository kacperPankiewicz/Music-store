...
<body>
    <div id="container">
        ...
        <img src="okladki/problem.jpg" height="400" width="400" style="margin-top: 40px;margin-left:90px;margin-right: 40px;">
        <P style="padding-left:100px"><h3> &nbsp&nbsp&nbsp&nbsp&nbsp  PRO8l3M - Art Brut 2</h3></P>
        <table style="width:auto;padding-left:28%">
       <form action="PRO8l3M.php" method="GET">
       <tr>
...
?>
        ...
        <?php
              ...
              $sql = "select onstock from produkt where author='PRO8l3M'";
              ...
              if($row[0]>=$value){
                if($value>0)
            {
                $order = new Disc("PRO8l3M ","Art Brut 2",$value,$how_much);
