...
<body>
    <div id="container">
        ...
        <img src="okladki/usmiech.jpg" height="400" width="400" style="margin-top: 40px;margin-left:90px;margin-right: 40px;">
        <P style="padding-left:100px"><h3> &nbsp&nbsp&nbsp&nbsp&nbsp  Pezet - Muzyka Poważna</h3></P>
        <table style="width:auto;padding-left:28%">
       <form action="pezet.php" method="GET">
       <tr>
...
?>
        ...
        <div style="float:right;margin-top:10%"><button class="button" onclick="location.href='index.php';">Powrót</button></div>
         <?php
              ...
              $sql = "select onstock from produkt where author='Pezet'";
              ...
              if($row[0]>=$value){
                if($value>0)
            {
                $order = new Disc("Pezet","Muzyka poważna",$value,$how_much);
