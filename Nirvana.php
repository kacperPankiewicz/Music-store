...
<body>
    <div id="container">
        ...
        <img src="okladki/nirvana.jpg" height="400" width="400" style="margin-top: 40px;margin-left:90px;margin-right: 40px;">
        <P style="padding-left:100px"><h3> &nbsp&nbsp&nbsp&nbsp&nbsp  Nirvana - Nevermind</h3></P>
        <table style="width:auto;padding-left:28%">
       <form action="Nirvana.php" method="GET">
       <tr>
...
?>
        ...
        <?php
              ...
              $sql = "select onstock from produkt where author='Nirvana'";
              ...
              if($row[0]>=$value){
                if($value>0)
            {
                $order = new Disc("Nirvana","Nevermind",$value,$how_much);
